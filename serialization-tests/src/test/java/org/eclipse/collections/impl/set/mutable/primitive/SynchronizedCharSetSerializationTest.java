...
public class SynchronizedCharSetSerializationTest
{
    @Test
    public void serializedForm()
    {
        Verify.assertSerializedForm(
                ...
                "rO0ABXNyAEZvcmcuZWNsaXBzZS5jb2xsZWN0aW9ucy5pbXBsLnNldC5tdXRhYmxlLnByaW1pdGl2\n"
                        ...
                        + "aW1wbC5zZXQubXV0YWJsZS5wcmltaXRpdmUuQ2hhckhhc2hTZXQAAAAAAAAAAQwAAHhwdwQAAAAA\n"
                        + "eHEAfgAE",
                new SynchronizedCharSet(new CharHashSet()));
    }
}
