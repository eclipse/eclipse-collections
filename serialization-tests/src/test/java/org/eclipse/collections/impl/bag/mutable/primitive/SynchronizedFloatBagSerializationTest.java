...
public class SynchronizedFloatBagSerializationTest
{
    @Test
    public void serializedForm()
    {
        Verify.assertSerializedForm(
                ...
                "rO0ABXNyAEdvcmcuZWNsaXBzZS5jb2xsZWN0aW9ucy5pbXBsLmJhZy5tdXRhYmxlLnByaW1pdGl2\n"
                        + "ZS5TeW5jaHJvbml6ZWRGbG9hdEJhZwAAAAAAAAABAgAAeHIAXW9yZy5lY2xpcHNlLmNvbGxlY3Rp\n"
                        ...
                        + "bnMuaW1wbC5iYWcubXV0YWJsZS5wcmltaXRpdmUuRmxvYXRIYXNoQmFnAAAAAAAAAAEMAAB4cHcE\n"
                        + "AAAAAHhxAH4ABA==",
                new SynchronizedFloatBag(new FloatHashBag()));
    }
}
