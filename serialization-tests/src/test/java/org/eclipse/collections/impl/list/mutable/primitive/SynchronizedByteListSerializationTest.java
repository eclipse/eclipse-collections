    ...
    public void serializedForm()
    {
        Verify.assertSerializedForm(
                ...
                "rO0ABXNyAEhvcmcuZWNsaXBzZS5jb2xsZWN0aW9ucy5pbXBsLmxpc3QubXV0YWJsZS5wcmltaXRp\n"
                        + "dmUuU3luY2hyb25pemVkQnl0ZUxpc3QAAAAAAAAAAQIAAHhyAFxvcmcuZWNsaXBzZS5jb2xsZWN0\n"
                        + "aW9ucy5pbXBsLmNvbGxlY3Rpb24ubXV0YWJsZS5wcmltaXRpdmUuQWJzdHJhY3RTeW5jaHJvbml6\n"
                        + "ZWRCeXRlQ29sbGVjdGlvbgAAAAAAAAABAgACTAAKY29sbGVjdGlvbnQASExvcmcvZWNsaXBzZS9j\n"
                        ...
                        + "cy5pbXBsLmxpc3QubXV0YWJsZS5wcmltaXRpdmUuQnl0ZUFycmF5TGlzdAAAAAAAAAABDAAAeHB3\n"
                        + "BAAAAAB4cQB+AAQ=",
                new SynchronizedByteList(new ByteArrayList()));
    }
}
