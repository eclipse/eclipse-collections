...
public class UnmodifiableLongBagSerializationTest
{
    @Test
    public void serializedForm()
    {
        Verify.assertSerializedForm(
                ...
                "rO0ABXNyAEZvcmcuZWNsaXBzZS5jb2xsZWN0aW9ucy5pbXBsLmJhZy5tdXRhYmxlLnByaW1pdGl2\n"
                        + "ZS5Vbm1vZGlmaWFibGVMb25nQmFnAAAAAAAAAAECAAB4cgBcb3JnLmVjbGlwc2UuY29sbGVjdGlv\n"
                        ...
                        + "cHNyAD5vcmcuZWNsaXBzZS5jb2xsZWN0aW9ucy5pbXBsLmJhZy5tdXRhYmxlLnByaW1pdGl2ZS5M\n"
                        + "b25nSGFzaEJhZwAAAAAAAAABDAAAeHB3BAAAAAB4",
                new UnmodifiableLongBag(new LongHashBag()));
    }
}
